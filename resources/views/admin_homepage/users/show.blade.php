    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">                    
                    <form action="{{ route('admin.homepage.users.update', $user->id) }}" method="POST">
                        @csrf
                        @method('PUT') 
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="birth_date" class="form-control datepicker @error('birth_date') is-invalid @enderror" value="{{ $user->user_detail->birth_date ? \Carbon\Carbon::createFromFormat('Y-m-d', $user->user_detail->birth_date)->format('d/m/Y') : "" }}" placeholder="31/12/1993 (tanggal/bulan/tahun)">
                                        @error('birth_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group text-right">
                                    <div class="col-md-12">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('admin.homepage.users.index') }}"> Kembali</a>
